...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-key" data-rule="required" class="form-control" name="row[key]" type="text">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-post" class="form-control" name="row[post]" type="text">
        </div>
    </div>
...
<script>
    function RndNum(n) {
     ...
     keyForm.value = Math.random().toString(36).substr(2);//RndNum(len);
</script>
