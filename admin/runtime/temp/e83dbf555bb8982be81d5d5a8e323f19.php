        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade active in" id="one">
                ...
                <!--     <div class="col-sm-3 col-xs-6">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span id="totalValue"><?php echo $totalviews; ?></span>
              ...
              <!--       <div class="col-sm-3 col-xs-6">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div id="echart" style="height:400px;width:150%;"></div>
                    </div>
             <!--        <div class="col-lg-4">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                <ul class="products-list product-list-in-box">
                                    <?php $__FOR_START_1981082553__=1;$__FOR_END_1981082553__=8;for($i=$__FOR_START_1981082553__;$i < $__FOR_END_1981082553__;$i+=1){ ?>
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="/admin/public/assets/img/avatar.png" style="height:40px;width:40px;">
                                        </div>
